 ...
 * \author Liang Xiang
*/
#ifndef MXNET_OPERATOR_CTC_INL_H_
#define MXNET_OPERATOR_CTC_INL_H_
...
struct CTCParam : public dmlc::Parameter<CTCParam> {
  float grad_scale;
...
class CTCOp : public Operator {
 public:
  explicit CTCOp(CTCParam param) : param_(param) {}
