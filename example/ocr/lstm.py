...
def lstm_unroll(num_lstm_layer, seq_len,
    ...
    for seqidx in range(seq_len):
        ...
        hidden = mx.sym.Reshape(data = hidden, target_shape = (50, 1, 10, 30))
        hidden = mx.sym.Convolution(data = hidden, kernel=(3,3), num_filter = 16)
        hidden = mx.sym.Pooling(data = hidden, pool_type = "max", kernel = (2,2), stride = (1,1))
